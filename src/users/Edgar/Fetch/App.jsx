...
export default function App() {
	...
	const handleEditPost = (id, userId) => { 
		const todo = {
			...
			body: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores nihil reprehenderit repellendus numquam, consequuntur culpa ipsum rem saepe nisi, est expedita veritatis corrupti magnam quo?'
		}
